                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="qty mt-5" style="margin-top:30%">
                                    ...
                                    <input type="number" onchange="updateQtyKey({{$detail_transaction2->id_detail}})" id="qty_{{$detail_transaction2->id_detail}}" class="count2 count_{{$detail_transaction2->id_detail}}" name="qty" value="{{$detail_transaction2->qty}}">
                                    <span class="plus bg-dark" onclick="plus({{$detail_transaction2->id_detail}}, {{$detail_transaction2->id_transaction}})">+</span> --}}
                                    <input min="1" type="number" onchange="updateQtyKey({{$detail_transaction2->id_detail}})" id="qty_{{$detail_transaction2->id_detail}}" name="qty" value="{{$detail_transaction2->qty}}">
                                </div>
                            </td>
