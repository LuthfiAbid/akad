			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img height="240px" src="./img/pakaian.jpg" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img height="240px" src="./img/sorban.jpg" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img height="240px" src="./img/kurma.png" alt="">
							</div>
							<div class="shop-body">
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product" onclick="window.location.href='view_barang.php'" style="cursor:pointer;">
											...
											<div class="product-body">
												...
												<h4 class="product-price">Rp. 200.000<del class="product-old-price"></del></h4>
